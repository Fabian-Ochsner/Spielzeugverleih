...
namespace Spielzeugverleih.Controllers
{
    public class AusgeliehensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AusgeliehenID,SpielzeugID,DatumVon,DatumBis,Price,Mieter")] Ausgeliehen ausgeliehen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AusgeliehenID,SpielzeugID,DatumVon,DatumBis,Price,Mieter")] Ausgeliehen ausgeliehen)
        {
            if (ModelState.IsValid)
            {
